    ...
    return (<
        ...
        label
                                                    for="inputname" > Name < /label> <
                                                        input value={inputs.name_of_kin}
                                                        onChange={
                                                            (e) => onChange(e)}
                                                        name="name_of_kin" /
                                                    >
        ...
        div class="form-group col-md-3 input-padding" >
                                                        <
        label
                                                            for="inputname" > Relation < /label> <
                                                                input value={inputs.relation}
                                                                onChange={
                                                                    (e) => onChange(e)}
                                                                name="relation" /
                                                            >
        ...
        div class="form-group col-md-3 input-padding" >
                                                                <
        label
                                                                    for="inputname" > Address < /label> <
                                                                        input value={inputs.add_nkd}
                                                                        onChange={
                                                                            (e) => onChange(e)}
                                                                        name="add_nkd" /
                                                                    >
        ...
        div class="form-group col-md-3 input-padding" >
                                                                        <
        label
                                                                            for="inputname" > No of childrens < /label> <
                                                                                input value={inputs.no_of_child}
                                                                                onChange={
                                                                                    (e) => onChange(e)}
                                                                                name="no_of_child" /
                                                                            >
        ...
        thead >
                                                                                        <
        tr class="table-info" > { /* <th class="text-center">Sr.no</th> */} <
        ...
        button id="add_row"
                                                                                                                                                disabled={formInputs.name === "" || !formInputs.dob || !formInputs.ppno}
        ...
        div class="d-flex justify-content-between" >
                                                                                                                                                                                                                <
        button class="btn btn-primary btnPrevious2 my-3"
                                                                                                                                                                                                                    onClick={
                                                                                                                                                                                                                        (e) => {
                                                                                                                                                                                                                            e.preventDefault();
                                                                                                                                                                                                                            navigate("/");
                                                                                                                                                                                                                    ...
                                                                                                                                                                                                                    Previous <
        /button> <
        button class="btn btn-primary btnNext2 my-3 "
                                                                                                                                                                                                                        onClick={
                                                                                                                                                                                                                            (e) => {
                                                                                                                                                                                                                                e.preventDefault();
