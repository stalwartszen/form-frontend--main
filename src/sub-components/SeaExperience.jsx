...
const SeaExperience = ({ inputs, setInputs }) => {
    ...
    return ( <
        ...
        td >
        <
        select name = "manned_unmanned_engine_room"
        class = "form-control "
        ...
        button id = "add_row"
        disabled={!formInputs.BHP || !formInputs.DWT || !formInputs.Employer || !formInputs.RANK || !formInputs.RPSL || !formInputs.engine_model || !formInputs.from || formInputs.manned_unmanned_engine_room || !formInputs.steam_motor || !formInputs.to || !formInputs.total || !formInputs.vessel_name}
        ...
        <
        button class = "btn btn-primary btnPrevious15"
        onClick = {
            (e) => {
                e.preventDefault();
        ...
        Previous <
        /button> <
        button class = "btn btn-primary btnNext15"
        onClick = {
            (e) => {
                e.preventDefault();
